...
```{r setup}
knitr::opts_knit$set(root.dir = normalizePath("/Users/astridrr/Desktop/Wiers_Lab/Projects/ABC_FC/Astrid_code")) # This sets the working directory to your specified path.
```
